#ifndef SHAPONES_XIAO_RP2350_PARALLEL_SWITCH_HPP
#define SHAPONES_XIAO_RP2350_PARALLEL_SWITCH_HPP

#include <stdint.h>

namespace shapones::xiao::rp2350::keypad {

static constexpr int NUM_PARALLELS = 3;
static constexpr int NUM_LEVELS = 1 << NUM_PARALLELS;
